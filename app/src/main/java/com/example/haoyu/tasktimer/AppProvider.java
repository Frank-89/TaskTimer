...
public class AppProvider extends ContentProvider {
    ...
    static final String CONTENT_AUTHORITY = "com.example.haoyu.tasktimer.provider";
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        //  eg. content://com.example.haoyu.tasktimer.provider/Tasks
        matcher.addURI(CONTENT_AUTHORITY, TasksContract.TABLE_NAME, TASKS);
        // e.g. content://com.example.haoyu.tasktimer.provider/Tasks/8
